...
function App() {
  ...
  if (loading) {
    return <div className="loader-screen" aria-live="polite" aria-busy="true"><div className="loader-orbit"><div className="loader-core" /><div className="loader-ring ring-one" /><div className="loader-ring ring-two" /></div><p>Loading your toolkit...</p></div>;
  }
